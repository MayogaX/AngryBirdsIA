...
import me.mayogax.ab.demo.other.ClientActionRobot;
import me.mayogax.ab.demo.other.ClientActionRobotJava;
import me.mayogax.ab.planner.TrajectoryPlanner;
...
//MX agent (server/client version)

public class ClientMXAgent implements Runnable {
	 ...
	 * */
	public ClientMXAgent(String ip) {
	...
	public ClientMXAgent(String ip, int id)
	{
		ar = new ClientActionRobotJava(ip);
		tp = new TrajectoryPlanner();
		randomGenerator = new Random();
	...
	public static void main(String args[]) {
		...
		ClientMXAgent na;
		if(args.length > 0)
			na = new ClientMXAgent(args[0]);
		else
			na = new ClientMXAgent();
		na.run();
